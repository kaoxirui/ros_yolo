...
import random
sys.path.append("/home/lift1/rs_yolo_ws/src/rs_yolo/scripts/")
...
def publish_image(real_x, real_y, real_z, classification, confidence):
    ...
    target_position.pose.position.x=detect_result.x
    target_position.pose.position.y=detect_result.y
    
    target_position.pose.position.z=detect_result.z
...
if __name__ == "__main__":
    ...
    pub = rospy.Publisher("/detect_result_out", PoseStamped, queue_size=10)
    ...
    model = YoloV5(yolov5_yaml_path='/home/lift1/rs_yolo_ws/src/rs_yolo/scripts/config/yolov5s.yaml')
